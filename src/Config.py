...
class Config(object):
    ...
    def createArguments(self):
        ...
        self.parser.add_argument('--homepage', help='Web interface Homepage', default='AHeLLoZZeps5VTxmKvuD49AS7X9ruNy5C8', metavar='address') # 1HeLLo4uzjaLetFx6NH3PMwFP3qbRbTf3D
        self.parser.add_argument('--updatesite', help='Source code update site', default='AZeroXLXwzWP29rNxhECnoiuej6dhdUq2Y', metavar='address')
